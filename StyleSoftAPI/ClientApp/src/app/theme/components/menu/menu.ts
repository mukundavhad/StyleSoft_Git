...
export const verticalMenuItems = [ 
    ...
    new Menu(201, 'Manage Staff', '/staff', null, 'wrench', null, true, 0),
    new Menu(201, 'Manage Location', '/saloon', null, 'wrench', null, true, 0),
    new Menu(201, 'Manage Services', '/services', null, 'wrench', null, true, 0),
    new Menu(201, 'Manage Offers', '/', null, 'wrench', null, true, 0),
    new Menu(201, 'Todays Queue', '/', null, 'wrench', null, true, 0),
    new Menu(201, 'Appointments', '/appointment', null, 'wrench', null, true, 0),
    new Menu(201, 'Sales Reports', '/', null, 'wrench', null, true, 0),
    new Menu(201, 'Update Profile', '/', null, 'wrench', null, true, 0),
    new Menu(201, 'Enrolled Saloon', '/enroll', null, 'wrench', null, true, 0),
    
    //new Menu(201, 'Address', '/address', null, 'wrench', null, true, 0),
    //new Menu(201, 'Services Category', '/category', null, 'wrench', null, true, 0),
