...
export const verticalMenuItems = [ 
    ...
    new Menu(201, 'Appointment', '/appointment', null, 'wrench', null, true, 0),
    new Menu(201, 'Enrolled Saloon', '/enroll', null, 'wrench', null, true, 0),
    new Menu(201, 'Saloon', '/saloon', null, 'wrench', null, true, 0),
    new Menu(201, 'Service Category', '/category', null, 'wrench', null, true, 0),
    new Menu(201, 'Services Details', '/services', null, 'wrench', null, true, 0),
    new Menu(201, 'Staff Details', '/staff', null, 'wrench', null, true, 0),
    new Menu(75, 'Address', '/address', null, 'wrench', null, true, 0),
